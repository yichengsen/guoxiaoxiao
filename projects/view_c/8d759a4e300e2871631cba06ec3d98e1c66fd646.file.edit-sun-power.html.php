<?php /* Smarty version Smarty-3.1.18, created on 2016-10-18 10:07:13
         compiled from ".\view\power\edit-sun-power.html" */ ?>
<?php /*%%SmartyHeaderCode:28039580583d1bc8ca5-27245391%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8d759a4e300e2871631cba06ec3d98e1c66fd646' => 
    array (
      0 => '.\\view\\power\\edit-sun-power.html',
      1 => 1476692638,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '28039580583d1bc8ca5-27245391',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_580583d1d6f8e3_50245779',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_580583d1d6f8e3_50245779')) {function content_580583d1d6f8e3_50245779($_smarty_tpl) {?><link rel="stylesheet" type="text/css" href="static/h-ui/css/erweima-style.css" />
<body>
...
?>
                                <li>
                                    <label>子类名称：</label>
                                    <input type="text" name="power_name" id="power_names" class="w200 name" onblur="check_sunname()" value="<?php echo $_smarty_tpl->tpl_vars['arr']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sn']['index']]['power_name'];?>
">
									<span id="s_powernames"></span>
                                </li>
                                <li>
                                    <label>英文名称：</label>
                                    <input type="text" name="controller_way" id="controller_way" class="w200 name" onblur="check_way()" value="<?php echo $_smarty_tpl->tpl_vars['arr']->value[$_smarty_tpl->getVariable('smarty')->value['section']['sn']['index']]['controller_way'];?>
">
...
<script type="text/javascript" src="static/h-ui/js/power/edit-sun-power.js"></script><?php }} ?>
